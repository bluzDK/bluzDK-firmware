...
#define LSM9DS1_M_CS	A2 // Can be any digital pin
#define LSM9DS1_AG_CS	A1  // Can be any other digital pin
...
{
    Serial1.begin(38400);
    Serial1.println("Starting IMU in SPI mode");
    ...
    if (!imu.begin())
    {
        Serial1.println("Failed to communicate with LSM9DS1.");
        Serial1.println("Double-check wiring.");
        Serial1.println("Default settings in this sketch will " \
...
void printGyro()
{
    ...
    Serial1.print(imu.calcGyro(imu.gx), 2);
    Serial1.print(", ");
    Serial1.print(imu.calcGyro(imu.gy), 2);
    Serial1.print(", ");
    Serial1.println(imu.calcGyro(imu.gz), 2);
#elif defined PRINT_RAW
    Serial1.print(imu.gx);
    Serial1.print(", ");
    Serial1.print(imu.gy);
    Serial1.print(", ");
    Serial1.println(imu.gz);
#endif
}
...
void printAccel()
{
    ...
    Serial1.print(imu.calcAccel(imu.ax), 2);
    Serial1.print(", ");
    Serial1.print(imu.calcAccel(imu.ay), 2);
    Serial1.print(", ");
    Serial1.println(imu.calcAccel(imu.az), 2);
#elif defined PRINT_RAW
    Serial1.print(imu.ax);
    Serial1.print(", ");
    Serial1.print(imu.ay);
    Serial1.print(", ");
    Serial1.println(imu.az);
#endif
...
void printMag()
{
    ...
    Serial1.print(imu.calcMag(imu.mx), 2);
    Serial1.print(", ");
    Serial1.print(imu.calcMag(imu.my), 2);
    Serial1.print(", ");
    Serial1.println(imu.calcMag(imu.mz), 2);
#elif defined PRINT_RAW
    Serial1.print(imu.mx);
    Serial1.print(", ");
    Serial1.print(imu.my);
    Serial1.print(", ");
    Serial1.println(imu.mz);
#endif
}
                   ...
                   float ax, float ay, float az, float mx, float my, float mz)
{
    ...
    Serial1.print("Pitch, Roll: ");
    Serial1.print(pitch, 2);
    Serial1.print(", ");
    Serial1.println(roll, 2);
    Serial1.print("Heading: "); Serial1.println(heading, 2);
}