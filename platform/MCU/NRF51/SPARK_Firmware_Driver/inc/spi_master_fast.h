...
typedef enum
{
    ...
    SPI_MODE_ZERO = 0,          /*!< Sample data at rising edge of clock and shift serial data at falling edge */
    SPI_MODE_ONE,              /*!< sample data at falling edge of clock and shift serial data at rising edge */
    //------------------------Clock polarity 1, Clock starts with level 1-------------------------------------------
    SPI_MODE_TWO,              /*!< sample data at falling edge of clock and shift serial data at rising edge */
    SPI_MODE_THREE               /*!< Sample data at rising edge of clock and shift serial data at falling edge */
} SPI_mode_t;
